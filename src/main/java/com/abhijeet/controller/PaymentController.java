...
import com.abhijeet.exception.OrderException;
import com.abhijeet.exception.UserException;
import com.abhijeet.modal.Order;
import com.abhijeet.modal.User;
import com.abhijeet.repository.OrderRepository;
import com.abhijeet.response.ApiResponse;
import com.abhijeet.response.PaymentLinkResponse;
import com.abhijeet.service.OrderService;
import com.abhijeet.service.UserService;
import com.abhijeet.user.domain.OrderStatus;
import com.abhijeet.user.domain.PaymentStatus;
...
//			order.setOrderItems(order.getOrderItems());
		...
		new RedirectView("https://shopwithabhi.vercel.app/payment/failed");
		throw new RazorpayException(e.getMessage());
	}
